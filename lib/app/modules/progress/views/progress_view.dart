...
import 'package:lwp_for_student/app/components/common_table.dart';
import 'package:lwp_for_student/app/components/stsubject_vertical.dart';
  ...
  Widget feebackWidget() {
    return Column(
      ...
      children: [
        ...
        24.kheightBox,
        feedback(ImageConstant.profileImg, 'Esther Howard',
            'It’s good to see improvement in English so far.', '01:50 pm'),
        8.kheightBox,
        feedback(ImageConstant.profileImg, 'Esther Howard',
            'It’s good to see improvement in English so far.', '01:50 pm'),
      ],
...
//Widget for feedback section by teachers
  ...
  Widget keyFocus(String focusImg, String title1, String title2, String title3,
      String title4) {
    return SizedBox(
      width: 343.kw,
      height: 60.kh,
            ...
            Column(
              ...
              children: [
                ...
                ReUsableRichText(
                    ...
                    text2: title4,
                    style1:
                        TextStyleUtil.kText12_4(fontWeight: FontWeight.w400),
                    style2: TextStyleUtil.kText12_4(
                        fontWeight: FontWeight.w400,
                        color: Get.context!.kLightTextColor)),
              ],
            )
